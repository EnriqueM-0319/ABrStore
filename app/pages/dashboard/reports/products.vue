...
<template>
 ...
 <UButton to="/dashboard/products" label="Ver productos" icon="i-lucide-package" />
 <UButton to="/dashboard/stockExits/history" label="Historial de salidas" icon="i-lucide-list" color="neutral" variant="soft" />
 </div>
 </div>
 </div>
 </UCard>

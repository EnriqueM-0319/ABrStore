      ...
      <template v-else>
        ...
        <UCard v-else-if="!tickets.length" :ui="{ root: 'rounded-2xl ring-[#dde3de]' }">
          <div class="py-16 text-center">
            ...
            <UButton class="mt-5" to="/dashboard/ventas" label="Ir a punto de venta" icon="i-lucide-monitor-up" />
          </div>
        </UCard>
            ...
            <UCard v-if="selectedTicket" :ui="{ root: 'rounded-2xl ring-[#dde3de]', header: 'px-4 py-4 sm:px-5', body: 'p-0', footer: 'px-4 py-4 sm:px-5' }">
              ...
              <template #footer>
                <div class="space-y-4">
                  ...
                  <UButton block label="Regresar a punto de venta" icon="i-lucide-monitor-up" color="neutral" variant="ghost" to="/dashboard/ventas" />
                </div>
              </template>
            </UCard>
          </section>
